...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText("ashiasish1858@gmail.com");
    setCopied(true);
  };
  return (
    <div
    ...
    >
      <div className={`${id === 6 && "flex justify-center"} h-full`}>
        ...
        {id === 6 && (
          <BackgroundGradientAnimation containerClassName="rounded-3xl">
        ...
        >
          <div className="font-sans font-normal text-neutral-600 text-sm dark:text-neutral-300 md:text-xs lg:text-base z-10">
            {description}
          </div>
          ...
          {id === 3 && (
            <div className=" flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2">
              ...
              <div className="flex flex-col gap-3 lg:gap-8 ">
                <span className="py-4 px-3 rounded-lg bg-[#10132e] text-center" />
                {["Express.js", "Node.js", "JavsScript"].map((item) => (
                  <span
                    key={item}
                    className="py-2 lg:px-3 px-3 text-xs lg:text-base opacity-50 lg:opacity-100 rounded-lg text-center bg-[#10132E]"
                  >
          ...
          {id === 6 && (
            <div className="mt-5 relative z-100">
              <div
